...
try{
  ...
  var actualRecord = nlapiLoadRecord('inventoryadjustment', actualRecordId);
...
for (var x = 1; x <= counterItems; x++) {
      ...
      var typeItem = actualRecord.getLineItemValue('inventory', 'itemtype', x);      
      var itemName = actualRecord.getLineItemText('inventory', 'item', x);
